...
public class GlobalVariable {
    ...
    public void setSearchobj(SearchEanPanel Searchobj) {
        this.Searchobj = Searchobj;
    }

    public SearchEanPanelNormal getSearchNormalobj() {
        return SearchNormalobj;
    }

    public void setSearchNormalobj(SearchEanPanelNormal SearchNormalobj) {
        this.SearchNormalobj = SearchNormalobj;
    }
